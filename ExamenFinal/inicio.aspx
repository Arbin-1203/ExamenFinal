...
<body>
    <form id="form1" runat="server">
        <div>
            Veterinaria Sol</p>
<p class="auto-style1">
    <asp:Image ID="Image1" runat="server" Height="288px" ImageUrl="~/Imagenes/little-cute-animal-doctor-veterinarian-dog-puppy-cartoon-pet-health-care-vector.jpg" Width="268px" />
</p>
            <p class="auto-style1">
